package com.sremella.alexa.sdk;
...
/*
    Copied from https://gist.github.com/KayLerch/8bfcb2d3b895e0bfccaf34d8f8550e9e
 */
public class FixedSpeechletResponse extends SpeechletResponse {
    ...
    private void samples() {
        ...
        final SpeechletResponse response = FixedSpeechletResponse
                .ask()
        ...
        final SpeechletResponse response2 = FixedSpeechletResponse
                .tell()
                .withText("Some text")
        ...
        final SpeechletResponse response3 = FixedSpeechletResponse
                .withShouldEndSession(true)
                .withText("Session ends.")
                .build();
    }

    private FixedSpeechletResponse(final AlexaSpeechletBuilder builder) {
    ...
    public static class AlexaSpeechletBuilder {
        ...
        public FixedSpeechletResponse build() {
            ...
            return new FixedSpeechletResponse(this);
        }
    }
}